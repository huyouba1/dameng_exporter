...
`
 ...
 WHERE A.USERNAME NOT IN('SYS','SYSSSO','SYSAUDITOR');`
	...
	//新增需求 20250401
	//查询归档的所有发送状态信息
	QueryArchiveSendStatusSql = `select /*+DMDB_CHECK_FLAG*/ case ARCH_STATUS when 'INVALID' then 0 when 'VALID' then 1 when 'ASYNC_SEND' then 2 else -2 end ARCH_STATUS,ARCH_TYPE,ARCH_DEST,ARCH_SRC from v$arch_status`
	//归档信息LSN详情
